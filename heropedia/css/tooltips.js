...
var g_IMGBaseURL = 'https://steamcdn-a.akamaihd.net/apps/dota2/images/';
	...
	$('<link>').attr(
		{
			rel:"stylesheet",
			type:"text/css",
			href:"https://www.dota2.com/public/css/tooltips.css?v=b5095866"
		}
	).appendTo('head');
...
function BuildItemTooltipHTML( itemName )
{
	...
	strHTML += '<div class="itemIcon"><img src="/heropedia/items/imagesitems/'+iData.img+'" width="74" height="56" alt="'+iData.dname+'" title="'+iData.dname+'" border="0" /></div>';
...
function BuildAbilityTooltipHTML( abilityName )
{
	...
	if ( aData !== undefined ) {
		...
		strHTML += '<div class="abilityName">'+"Attribute Bonus"+'</div>';
		strHTML += '<div class="abilityHR1"></div>';
		strHTML += '<div class="abilityDesc">'+"Attribute bonuses directly affect all three of a Hero's primary attributes: Strength, Agility, and Intelligence."+'</div>';
	}
...
function BuildHeroTooltipHTML( heroName )
{
	...
	strHTML += '<img style="top:'+(hData.pa=='str'?'42px':(hData.pa=='agi'?'21px':'0px'))+'" class="overviewIcon_Primary" src="https://steamcdn-a.akamaihd.net/apps/dota2/images/heropedia/overviewicon_primary_2.png" width="20" height="19" />';
	strHTML += '<img title="Intelligence" class="overviewIcon_Int" src="https://steamcdn-a.akamaihd.net/apps/dota2/images/heropedia/overviewicon_int_2.png" width="16" height="16" />';
	strHTML += '<div class="overview_StatVal overview_IntVal'+(hData.pa=='int'?' primaryVal':'')+'">'+hData.attribs.int.b+' + '+hData.attribs.int.g+'</div>';
	strHTML += '<img title="Agility" class="overviewIcon_Agi" src="https://steamcdn-a.akamaihd.net/apps/dota2/images/heropedia/overviewicon_agi_2.png" width="16" height="16" />';
	strHTML += '<div class="overview_StatVal overview_AgiVal'+(hData.pa=='agi'?' primaryVal':'')+'">'+hData.attribs.agi.b+' + '+hData.attribs.agi.g+'</div>';
	strHTML += '<img title="Strength" class="overviewIcon_Str" src="https://steamcdn-a.akamaihd.net/apps/dota2/images/heropedia/overviewicon_str_2.png" width="16" height="16" />';
	strHTML += '<div class="overview_StatVal overview_StrVal'+(hData.pa=='str'?' primaryVal':'')+'">'+hData.attribs.str.b+' + '+hData.attribs.str.g+'</div>';
	strHTML += '<img title="Damage" class="overviewIcon_Attack" src="https://steamcdn-a.akamaihd.net/apps/dota2/images/heropedia/overviewicon_attack_2.png" width="23" height="18" />';
	strHTML += '<div class="overview_StatVal overview_AttackVal">'+hData.attribs.dmg.min+' - '+hData.attribs.dmg.max+'</div>';
	strHTML += '<img title="Movespeed" class="overviewIcon_Speed" src="https://steamcdn-a.akamaihd.net/apps/dota2/images/heropedia/overviewicon_speed_2.png" width="31" height="19" />';
	strHTML += '<div class="overview_StatVal overview_SpeedVal">'+hData.attribs.ms+'</div>';
	strHTML += '<img title="Armor" class="overviewIcon_Defense" src="https://steamcdn-a.akamaihd.net/apps/dota2/images/heropedia/overviewicon_defense_2.png" width="19" height="18" />';
